...
Use the finalScore function below to do the following:
  1. Receive the callback function `inning` that was created in Task 
...
function scoreboard(getInningScoreCB, inningCB, numberInnings) {
  ...
  if(homeScore === awayScore){
    scoreByInning.push(`This game will require extra innings: Away ${currentInnings.Away} - Home ${currentInning.Home}`);
    }else{
